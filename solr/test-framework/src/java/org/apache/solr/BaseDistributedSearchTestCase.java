 ...
 * @ShardsFixed(num = N) or a @ShardsRepeat(min = M, max = N) to indicate
 * whether the test should be called once, with a fixed number of shards,
 ...
 * @ShardsFixed(num = N) for all tests without annotations in that class hierarchy.
 * Ideally this function should be retired in favour of better annotations..
 *
 * @since solr 1.5
 */
